...
Main objective of this work is to get familiar with plotting analyzing real life data using tools in matplotlib. For this, I have used data of 'Primary Energy Consumption in Select Countries of the World from 2012 to 2018' from [data.gov.in](data.gov.in) and represented it by different plots. 
